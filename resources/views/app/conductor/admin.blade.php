            ...
            <div class="row m-b-5">
                <div class="col-sm-12">
					...
					<div class="form-group">
						{!! Form::label('num_placa', 'Nombre:') !!}
						{!! Form::text('num_placa', '', array('class' => 'form-control input-xs', 'id' => 'num_placa')) !!}
					</div>
					<div class="form-group">
...
<script>
	$(document).ready(function () {
		...
		$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="num_placa"]').keyup(function (e) {
