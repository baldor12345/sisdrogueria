...
{!! Form::model($presentacion, $formData) !!}	
	...
	<div class="form-group">
		<div class="control-label col-lg-4 col-md-4 col-sm-4" style ="padding-top: 15px">
		{!! Form::label('sigla', 'Simbolo:') !!}<div class="" style="display: inline-block;color: red;">*</div>
		</div>
		<div class="col-lg-8 col-md-8 col-sm-8">
			{!! Form::text('sigla', null, array('class' => 'form-control input-xs', 'id' => 'sigla', 'placeholder' => 'Ingrese nombre')) !!}
		</div>
	</div>
	<div class="form-group">
