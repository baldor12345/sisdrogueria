...
<div class="row">
				...
				<div class="row m-b-10">
					<div class="col-sm-12">
						...
						<div class="form-group">
							{!! Form::label('nombre_codigo', 'Nombre:') !!}
							{!! Form::text('nombre_codigo', '', array('class' => 'form-control input-xs', 'id' => 'nombre_codigo')) !!}
						</div>
						{{-- <div class="form-group">
							{!! Form::label('dni', 'DNI:') !!}
	...
	<script>
		$(document).ready(function () {
			...
			$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="nombre_codigo"]').keyup(function (e) {
