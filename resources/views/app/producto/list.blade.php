	...
	<tbody>
		...
		@foreach($lista as $key => $value)
			<tr>
				...
				<td>{!! Form::button('<div class="glyphicon glyphicon-pencil"></div> Present.',array('onclick'=>'modal(\''.URL::route($ruta["adminpresentacion"],array($value->producto_id,'listar'=>'SI')).'\',\''.$titulo_presentacion.': '.$value->descripcion.'\',this);', 'class'=>'btn btn-xs btn-info')) !!}</td>
