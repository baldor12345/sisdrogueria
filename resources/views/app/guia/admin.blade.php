            ...
            <div class="row m-b-5">
                <div class="col-sm-12">
					...
					<div class="form-group">
						<label for="numero_serie" class="input-md">N° serie:</label>
						{!! Form::text('numero_serie', '', array('class' => 'form-control input-md', 'id' => 'numero_serie')) !!}
					</div>
					<div class="form-group">
						<label for="num_doc" class="input-md">DNI o RUC:</label>
						{!! Form::text('num_doc', '', array('class' => 'form-control input-md', 'id' => 'num_doc')) !!}
					</div>
					<div class="form-group">
...
<script>
	$(document).ready(function () {
		...
		$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="numero_serie"]').keyup(function (e) {
