        ...
        <div class="card-box table-responsive">
            ...
            <div class="row">
                <div class="col-sm-12">
					...
					{!! Form::button('<i class="glyphicon glyphicon-remove-circle"></i> Cierre ', array('class' => 'btn btn-danger waves-effect waves-light m-l-10 btn-xs', 'id' => 'btnCierreCaja', 'onclick' => 'modal (\''.URL::route($ruta["cierrecaja"], array('listar'=>'SI')).'\', \''.$titulo_cierrecaja.'\', this);')) !!}
